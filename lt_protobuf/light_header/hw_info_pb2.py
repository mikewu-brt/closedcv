...
_CAMERAMODULEHWINFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ir_cut_filter_removed', full_name='ltpb.CameraModuleHwInfo.ir_cut_filter_removed', index=12,
...
_CAMERAMODULEHWINFO.fields_by_name['id'].enum_type = lt__protobuf_dot_common_dot_camera__id__pb2._CAMERAID
...
_IMUMODULEHWINFO.fields_by_name['quaternion'].message_type = lt__protobuf_dot_common_dot_point4f__pb2._POINT4F
