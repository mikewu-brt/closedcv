...
# source: lt_protobuf/light_header/extra_sensors/gps_data.proto
...
_GPSDATA_PROCESSINGMETHOD = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PROCESSING_METHOD_DEAD_RECKONING', index=6, number=6,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_GPSHWINFO_GPSMODEL = _descriptor.EnumDescriptor(
  name='GPSModel',
  full_name='ltpb.GPSHwInfo.GPSModel',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_GPSHWINFO_GPSMODEL)
...
_GPSDATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='time_seconds', full_name='ltpb.GPSData.time_seconds', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='time_nanoseconds', full_name='ltpb.GPSData.time_nanoseconds', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='device_id', full_name='ltpb.GPSData.device_id', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='magnetic_track', full_name='ltpb.GPSData.magnetic_track', index=15,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='magnetic_variation', full_name='ltpb.GPSData.magnetic_variation', index=16,
...
_GPSHWINFO = _descriptor.Descriptor(
  name='GPSHwInfo',
  full_name='ltpb.GPSHwInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='model', full_name='ltpb.GPSHwInfo.model', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='hw_description', full_name='ltpb.GPSHwInfo.hw_description', index=1,
...
_GPSDATA.fields_by_name['magnetic_track'].message_type = _GPSDATA_TRACK
...
_GPSHWINFO.fields_by_name['model'].enum_type = _GPSHWINFO_GPSMODEL
_GPSHWINFO.fields_by_name['hw_description'].message_type = lt__protobuf_dot_light__header_dot_extra__sensors_dot_hardware__description__pb2._HARDWAREDESCRIPTION
_GPSHWINFO_GPSMODEL.containing_type = _GPSHWINFO
DESCRIPTOR.message_types_by_name['GPSData'] = _GPSDATA
DESCRIPTOR.message_types_by_name['GPSHwInfo'] = _GPSHWINFO
...
GPSData = _reflection.GeneratedProtocolMessageType('GPSData', (_message.Message,), {
  ...
  'ValueUncertainty' : _reflection.GeneratedProtocolMessageType('ValueUncertainty', (_message.Message,), {
    ...
    '__module__' : 'lt_protobuf.light_header.extra_sensors.gps_data_pb2'
...
GPSHwInfo = _reflection.GeneratedProtocolMessageType('GPSHwInfo', (_message.Message,), {
  'DESCRIPTOR' : _GPSHWINFO,
  '__module__' : 'lt_protobuf.light_header.extra_sensors.gps_data_pb2'
  # @@protoc_insertion_point(class_scope:ltpb.GPSHwInfo)
  })
_sym_db.RegisterMessage(GPSHwInfo)
