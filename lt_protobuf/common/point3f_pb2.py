...
# source: lt_protobuf/common/point3f.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='lt_protobuf/common/point3f.proto',
  package='ltpb',
  syntax='proto3',
  serialized_options=None,
  serialized_pb=b'\n lt_protobuf/common/point3f.proto\x12\x04ltpb\"*\n\x07Point3F\x12\t\n\x01x\x18\x01 \x01(\x02\x12\t\n\x01y\x18\x02 \x01(\x02\x12\t\n\x01z\x18\x03 \x01(\x02\x62\x06proto3'
)
...
Point3F = _reflection.GeneratedProtocolMessageType('Point3F', (_message.Message,), {
  'DESCRIPTOR' : _POINT3F,
  '__module__' : 'lt_protobuf.common.point3f_pb2'
